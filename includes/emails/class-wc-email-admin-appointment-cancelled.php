...
if ( ! class_exists( 'WC_Email_Admin_Appointment_Cancelled' ) ) :
	...
	class WC_Email_Admin_Appointment_Cancelled extends WC_Email {
		...
		public function __construct() {
			...
			add_filter( 'woocommerce_email_recipient_admin_appointment_cancelled', [ $this, 'email_recipients' ], 10, 2 );
			add_action( 'woocommerce_appointment_pending-confirmation_to_cancelled_notification', [ $this, 'trigger' ] );
			add_action( 'woocommerce_appointment_confirmed_to_cancelled_notification', [ $this, 'trigger' ] );
			add_action( 'woocommerce_appointment_paid_to_cancelled_notification', [ $this, 'trigger' ] );
			add_action( 'woocommerce_appointment_unpaid_to_cancelled_notification', [ $this, 'trigger' ] );
